...
public class PetActivateCommand extends Command {
    ...
    public void handleCommand(Entity entity, String message, String[] args) {
        ...
        // Resume pet AI by clearing the interaction timer
        if (pet.getRoomUser().getTask() != null) {
            pet.getRoomUser().getTask().setInteractionTimer(0);
        }
    }

    @Override
    public String getDescription() {
        return "Resumes a pet's AI (used by pet control panel)";
    }
}
